...
\title{A novel distance metric based on word embeddings for improving short
text classification with term clustering.}
...
\reviewertwo{Dr. Martin Schäler}

%% The advisors are PhDs or Postdocs
\advisorone{Dr. Matthias Keller}
%% The second advisor can be omitted
\advisortwo{M.Sc. Abel Elekes}

%% Please enter the start end end time of your thesis
\editingtime{15 December 2016}{15 June 2017}
